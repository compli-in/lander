    ...
    <section id="how-it-works" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {/* Connector line */}
          <div className="hidden md:block absolute top-8 left-1/3 right-1/3 h-px bg-gradient-to-r from-sky-500/0 via-sky-500/40 to-sky-500/0" />
            ...
            <div key={step.number} className="relative flex flex-col items-start gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-2xl bg-sky-500/10 border border-sky-500/20 flex items-center justify-center shrink-0">
                  <span className="text-sky-400 font-semibold text-lg">{step.number}</span>
                </div>
              </div>
